  ...
  return (
    <div ref={containerRef} style={{
      ...
      <div ref={(el) => itemsRef.current.push(el)} style={{
        ...
        <img src="/adam 5.jpeg" alt="Adam" style={{ width: '100%', height: '100%', objectFit: 'cover' }}
          onError={(e) => { e.target.src = '/adam 5.jpeg'; }} />
      </div>
      ...
      <p ref={(el) => itemsRef.current.push(el)} style={{ marginBottom: 14, fontWeight: 500, letterSpacing: '0.2px' }}>
        selamat ulang tahun yang ke-23 yaww, adamm. semoga setiap langkah mu senantiasa dipenuhi keberkahan, kesehatan, dan kelancaran dalam meraih setiap impian baikmu.
      </p>
      ...
      {/* Paragraph 4 */}
      <p ref={(el) => itemsRef.current.push(el)} style={{ marginBottom: 14, fontWeight: 500 }}>
        semoga apa yang kamu cita-citain bisa tercapai semuanya. semoga urusannya dimudahin, kerjanya lancar, sama apapun yang lagi kamu perjuangin sekarang nantinya bisa bikin kamu bangga sama diri kamu sendiri. aku pengen liat kamu berhasil dan bahagia, bukan cuma sekarang tapi sampai nanti nanti.
      </p>
      ...
      <div ref={(el) => itemsRef.current.push(el)} style={{
        ...
        <p style={{
          ...
          Selamat Ulang Tahun yang ke-23, Adam 🌸✨
        </p>
      </div>
    </div>
  );
...
function ImpianTab() {
  ...
  const dreams = [
    ...
    },
    {
      ...
      text: 'Meskipun jauh, aku bakal selalu ada buat dengerin cerita kamu, dukung setiap langkah, karier, dan impian Adam. You will never walk alone.',
    ...
    },
    {
      ...
      text: 'Merawat komitmen, kehangatan, dan rasa percaya satu sama lain.',
  ...
  return (
    <div ref={containerRef} style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        {[
          <span>Semoga di usiamu yang ke-23 ini, Adam selalu diberikan kesehatan, kelancaran kerja & urusan, dan perlindungan di mana pun kamu berada. 🤲🏻💖</span>,
          <span>May your days be filled with endless joy and peace, and may the distance never fade that sweet, handsome smile of yours! ✨</span>,
          ...
          <span>Semoga semua cita-cita dan harapan Adam di umur 23 tahun ini bisa tercapai satu per satu. 🥂</span>,
          <span>Terimakasih sudah hadir di hidup aku, selalu bikin aku ketawa dan bahagia dengan prilakuan mu itu. Semoga kita bakal bareng terus yaww dan lebih sering ketemu huaa. Happy 23rd birthday, sayangku🫶💕</span>
        ].map((item, i) => (
      ...
      {opened && (
        <div ref={letterRef} className="glass" style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: 18 }}>
            ...
            }}>Happy Birthday, Adam! 🎂✨</h1>
            <p style={{
              fontFamily: 'var(--font-cute)', fontSize: '0.78rem', color: '#4a6b34', fontWeight: 600,
            }}>Pesan hangat dan doa terbaik di usiamu yang ke-23 🌿</p>
          </div>
